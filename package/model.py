...
conn.execute('''CREATE TABLE if not exists patient_allergies
(pat_id INTEGER PRIMARY KEY AUTOINCREMENT,
pat_first_name TEXT NOT NULL,
pat_last_name TEXT NOT NULL,
pat_allergies TEXT NOT NULL,
FOREIGN KEY(pat_id) REFERENCES patient(pat_id));''')

conn.execute('''CREATE TABLE if not exists patient_vaccine
(pat_id INTEGER PRIMARY KEY AUTOINCREMENT,
pat_first_name TEXT NOT NULL,
pat_last_name TEXT NOT NULL,
pat_vaccine TEXT NOT NULL,
pat_vaccine_date DATE NOT NULL,
FOREIGN KEY(pat_id) REFERENCES patient(pat_id));''')

conn.execute('''CREATE TABLE if not exists patient_health
(pat_id INTEGER PRIMARY KEY AUTOINCREMENT,
pat_first_name TEXT NOT NULL,
pat_last_name TEXT NOT NULL,
pat_blood_pressure TEXT NOT NULL,
pat_blood_sugar TEXT NOT NULL,
FOREIGN KEY(pat_id) REFERENCES patient(pat_id));''')

conn.execute('''CREATE TABLE if not exists health_program
(program_id INTEGER PRIMARY KEY AUTOINCREMENT,
program_date DATE NOT NULL);''')

conn.execute('''CREATE TABLE if not exists health_news
